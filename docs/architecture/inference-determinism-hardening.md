...
| deterministic FP64 **matrix-ready** | all 17 inference-path opcodes, including indexed RoPE on protocol-owned ln/exp/two-pi/sin-cos |
| deterministic FP64 candidate | none (17/17 consensus_ready; 0 host-math opcodes) |
